...
public interface MenuCatConverter {
     ...
     *
     * @param request 请求
     * @return {@link MenuCatEntity }
     */
    MenuCatEntity toEntity(MenuCatAddRequest request);
     ...
     * @return {@link MenuCatEntity }
     */
    MenuCatEntity toEntity(MenuCatUpdateRequest request);

    void copy(MenuCatUpdateRequest request, @MappingTarget MenuCatEntity entity);
     ...
     */
    MenuCatResponse toResponse(MenuCatEntity entity);
     ...
     * @return {@link MenuCatResponse }
     */
    List<MenuCatResponse> toResponse(List<MenuCatEntity> entity);
}
