...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='打印机档口表';
...
CREATE TABLE `door_port_printers` (
    ...
    KEY `device_id` (`device_id`),
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='档口打印机关联表';

--更新item加一个档口关联字段
ALTER TABLE `pos_db`.`items`
...
CREATE TABLE `merchant_bank_cards` (
    ...
    PRIMARY KEY (`id`) USING BTREE,
    KEY `merchant_id` (`merchant_id`),
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商家银行卡表';
